                ...
                <section class="text-gray-600 body-font relative">
                    ...
                    <div class="container px-5 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full">
                            <div class="relative">
                                <label for="title" class="leading-7 text-sm text-gray-600">Message</label>
                            ...
                            <div class="p-2 w-full">
                            <div class="relative">
                                <label for="email" class="leading-7 text-sm text-gray-600">Mail address</label>
                            ...
                            <div class="p-2 w-full">
                            <div class="relative">
                                <label for="url" class="leading-7 text-sm text-gray-600">Homepage</label>
                            ...
                            <div class="relative">
                                ...
                                <select name="age">
                                    ...
                                    <option value="1" {{old('age') == 1 ? 'selected' : ''}}>~19 years</option>
                                    <option value="2" {{old('age') == 2 ? 'selected' : ''}}>20 years ~ 29 years</option>
                                    <option value="3" {{old('age') == 3 ? 'selected' : ''}}>30 years ~ 39 years</option>
                                    <option value="4" {{old('age') == 4 ? 'selected' : ''}}>40 years ~ 49 years</option>
                                    <option value="5" {{old('age') == 5 ? 'selected' : ''}}>50 years ~ 59 years</option>
                                    <option value="6" {{old('age') == 6 ? 'selected' : ''}}>60 years ~</option>
                                </select>
                            </div>
                            </div>
                            ...
                            <div class="p-2 w-full">
                            <div class="relative">
                                <label for="contact" class="leading-7 text-sm text-gray-600">Contact Message</label>
                            ...
                            <div class="p-2 w-full">
                            <div class="relative">
                                <input type="checkbox" id="caution" name="caution">Contents Permission and approval
                            </div>
                            </div>

                            <div class="p-2 w-full">
                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">New Register</button>
                            </div>
